...
---
p(#pdf-link). "(PDF Version)":resume.pdf
...
p(job-description). Video game developer with specialization in animation, optimization, and process improvement.
    * Shipped three titles (NASCAR 09 PS2, NSACAR Kart Racing Wii, and EA Sports MMA PS3/XBox 360) with two more in post-production (Madden NFL Football Nintendo 3DS and FIFA 2011 Nintendo 3DS)
    * Ported, optimized, and improved animation runtime libraries for PS2, Wii, XBox 360, PS3, and 3DS
    * Maintained and improved desktop animation tools for PC in C#, C++, and Managed C++
    * Optimized for speed and cache efficiency, rewriting problematic routines in PowerPC and ARM assembly
    ...
    * Contributed extensively to EA's shared source projects; improved procedures for game teams to contribute changes and avoid unnecessary code forking
...
p(job-description). Assisting independent music artists promote their releases through publicity on music blogs
    * Delivered over 12,000 promotional copies in our first year of operation, saving artists over $35K in material and shipping costs and *nearly 20 tons of Carbon Dioxide emissions*
